            ...
            for j in range(len(self.rootsys.PositiveRoots[i])):
                for k in range(i+1):
                    for l in range(j+1):
                        ...
                        # Computing for positive positive first
                        if newrootpospos in self.rootsys.roots:
                            ...
                            if not(self.rootsys.PositiveRoots[k][l] in self.rootsys.rootsyms):
                                ...
                                struct_constant = self.structure_constants[index1][index2][index0]
                                ...
                                struct_constant =  np.sqrt((j_val + m_val + 1) * (j_val - m_val) / 2) / self.raising_norm[common]
